  ...
  return (
    <div className="bg-gradient-to-br from-blue-100 via-white to-purple-100 min-h-screen flex items-center justify-center relative overflow-x-hidden">
      ...
      >
        ...
        <h2 className="text-3xl font-extrabold text-gray-900 mb-3 drop-shadow-2xl text-center">Create Your Free Account</h2>
        <p className="text-gray-700 mb-8 text-center">Start your learning journey with EduSmart today!</p>
